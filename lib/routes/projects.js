...
.post('/', bodyParser, (req, res, next) => {
  ...
  Project.findOne({description: req.body.parentId})
      ...
      .then(savedProj => {
        const parentId = savedProj.parentId;
        const newProjectObj = {};
        newProjectObj._id = savedProj._id;
        newProjectObj.userId = savedProj.userId;
        newProjectObj.description = savedProj.description;
        newProjectObj.parentId = {
          _id: parentId,
          description: req.body.parentId
        };
        res.send(newProjectObj);})
      .catch(next);
})
